...
HD_PWD='W:/ELEC3500/ELEC3500_LAB_9/EggTimer/EggTimer/EggTimer.runs/c_counter_binary_db_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_counter_binary_db.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_counter_binary_db.tcl
