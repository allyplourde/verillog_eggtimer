...
HD_PWD='W:/ELEC3500/ELEC3500_LAB_9/EggTimer/EggTimer/EggTimer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eggtimer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eggtimer.tcl
