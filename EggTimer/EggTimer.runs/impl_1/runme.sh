...
HD_PWD='W:/ELEC3500/ELEC3500_LAB_9/EggTimer/EggTimer/EggTimer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eggtimer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eggtimer.tcl -notrace
