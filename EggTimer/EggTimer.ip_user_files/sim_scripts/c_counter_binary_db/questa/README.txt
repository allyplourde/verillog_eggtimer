...
#
# Generated by export_simulation on Tue Mar 30 11:09:07 -0400 2021
#
################################################################################
...
switch to the './c_counter_binary_db.sh' script.

./c_counter_binary_db.sh -reset_run
...
./c_counter_binary_db.sh -noclean_files

For more information on the script, please type './c_counter_binary_db.sh -help'.
