...
#
# Generated by Vivado on Mon Mar 29 08:32:48 -0400 2021
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../EggTimer.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../EggTimer.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../EggTimer.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
